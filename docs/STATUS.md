...
| Real reference-corpus analysis + preset calibration (`engine/reference_vocab.py` -- MIDI/Guitar-Pro/audio input, real Krumhansl-Schmuckler key correlation, accumulating corpus cache, real preset-writing) | WIRED+TESTED | engine/ 654 passed, 1 skipped (up from 637); real 18-song corpus (Born of Osiris + Periphery + Veil of Maya) -> `labyrinth.json` preset; `"boo"` alias updated; verified live -- see TASKS.md's §17.6 tracker entry, 2026-09-10 |
