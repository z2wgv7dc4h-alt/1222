"""Compose a song from a preset + seed.

Labyrinth main riff: `riff_bank` then ThemeRegistry. Other presets: rhythm/motif path.
Do not import riff_model. Preview is GM. See docs/CURRENT.md.
"""
