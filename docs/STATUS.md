...
| Real reference-corpus analysis + preset calibration (`engine/reference_vocab.py` -- MIDI/Guitar-Pro/audio input, real Krumhansl-Schmuckler key correlation, accumulating corpus cache, real preset-writing, real drum-role + rhythm-pattern capture, real separate lead-guitar vocab calibration) | WIRED+TESTED | engine/ 668 passed, 1 skipped; real 31-song corpus (22 Born of Osiris + 6 Periphery + 3 Veil of Maya) -> `labyrinth.json` preset (139bpm, minor, pedal=0.95 real-measured after a real bug fix, real separate lead_vocab); `"boo"` alias updated; verified live -- see TASKS.md's §17.6 tracker entry, 2026-09-10/11 |
